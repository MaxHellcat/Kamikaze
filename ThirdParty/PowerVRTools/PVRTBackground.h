...
//#if defined(BUILD_OGL) || defined(BUILD_OGLES) || defined(BUILD_OGLES2) // Commented out by myself on 23 Dec 2010
		/*!***************************************************************************
		 @Function		Draw
...
//#elif defined(BUILD_DX10) // Commented out by myself on 23 Dec 2010
		/*!***************************************************************************
		 ...
		 @Description	Draws a texture on a quad covering the whole screen.
		*****************************************************************************/
//		EPVRTError Draw(ID3D10ShaderResourceView *pTexture); // Commented out by myself on 23 Dec 201
//#endif // Commented out by myself on 23 Dec 201
